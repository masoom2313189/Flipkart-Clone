...
const GiftForYourLovedOnesData = [
  {
    id: 1,
...
const GiftsForYourLovedOnes = () => {
  return (
    <ItemList
      data={GiftForYourLovedOnesData}
      item_name={"Gifts for Your Loved Ones"}
    />
  );
};

export default GiftsForYourLovedOnes;
