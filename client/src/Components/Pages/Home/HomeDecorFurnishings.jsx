...
const HomeDecorFurnishingsData = [
  {
    id: 1,
...
const HomeDecorFurnishings = () => {
  return (
    <ItemList
      data={HomeDecorFurnishingsData}
      item_name={"Home Decor & Furnishings"}
    />
  );
};

export default HomeDecorFurnishings;
